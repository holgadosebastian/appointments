...
describe("addCustomer", () => {
  ...
  beforeEach(() => {
    jest.spyOn(global, "fetch").mockReturnValue(fetchResponseOk(customer))
  ...
  it("dispatches ADD_CUSTOMER_VALIDATION_FAILD if validation errors were returned", () => {
    const errors = {
      field: "field",
      description: "error text",
    }

    global.fetch.mockReturnValue(fetchResponseError(422, { errors }))
